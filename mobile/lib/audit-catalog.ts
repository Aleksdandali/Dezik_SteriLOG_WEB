// Product catalog for inventory audits. MUST stay in sync with the Telegram
// Mini App (app/telegram/page.tsx) — same ids, names, groups, units, colors.
// The bot uses identical lists; any change here must be mirrored in the bot
// (and vice-versa) so that audit names line up across both clients.
